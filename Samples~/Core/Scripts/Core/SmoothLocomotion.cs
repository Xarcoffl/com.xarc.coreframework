...
namespace Xarc {
    ...
    public class SmoothLocomotion : MonoBehaviour {
        ...
        XarcPlayerController playerController;
        ...
        public virtual void CheckControllerReferences() {
            ...
            if (playerController == null) {
                playerController = GetComponentInParent<XarcPlayerController>();
            }
        ...
        public virtual void SetupCharacterController() {
            ...
            XarcPlayerController bng = GetComponent<XarcPlayerController>();
            if (bng) {
