...
namespace Xarc {
    ...
    public class Grabbable : MonoBehaviour {
        ...
        /// <summary>
        /// If a XarcPlayerController is provided we can check for player movements and make certain adjustments to physics.
        /// </summary>
        protected XarcPlayerController player {
            get {
                return GetBNGPlayerController();
            }
        }
        private XarcPlayerController _player;
        ...
        /// </summary>
        /// <returns></returns>
        public virtual XarcPlayerController GetBNGPlayerController() {
            ...
            if (GameObject.FindGameObjectWithTag("Player")) {
                return _player = GameObject.FindGameObjectWithTag("Player").GetComponentInChildren<XarcPlayerController>();
            }
            else {
                return _player = FindObjectOfType<XarcPlayerController>();
            }
        }
