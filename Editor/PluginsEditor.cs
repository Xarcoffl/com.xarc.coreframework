...
namespace Xarc {
    ...
    public class PluginsEditor : EditorWindow {
        ...
        [MenuItem("Xarc/Xarc XR Plugins Helper")]
        ...
        void OnGUI() {
            ...
            if (ShowedFirstRunWindow) {
                EditorGUILayout.HelpBox("This appears to be your fist time installing Xarc - awesome! Be sure to check out the Wiki link listed below for installation instructions and documentation.", MessageType.Info);
            ...
            AddLink("Xarc Wiki", "https://wiki.beardedninjagames.com");
            AddLink("Xarc Asset", "http://u3d.as/1JpA");
            AddLink("Xarc Discord", "https://discord.gg/BFauBCj");
