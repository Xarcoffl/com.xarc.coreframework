...
namespace Xarc {
    ...
    public class IntegrationsEditor : EditorWindow {
        ...
        [MenuItem("Xarc/Xarc Integrations")]
        ...
        void OnGUI() {
            GUILayout.Label("Xarc Integration Settings", EditorStyles.boldLabel);

            XarcSettings.XRITIntegration = EditorGUILayout.Toggle("XR Interaction Toolkit Integration", XarcSettings.XRITIntegration);
            XarcSettings.OculusIntegration = EditorGUILayout.Toggle("Oculus Integration", XarcSettings.OculusIntegration);
            XarcSettings.SteamVRIntegration = EditorGUILayout.Toggle("SteamVR Integration", XarcSettings.SteamVRIntegration);
            XarcSettings.PicoIntegration = EditorGUILayout.Toggle("Pico Integration (Legacy)", XarcSettings.PicoIntegration);
